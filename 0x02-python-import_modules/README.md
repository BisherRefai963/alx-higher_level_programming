#Bichr_Python - import & modules

In this project, we learned about importing and using functions and creating
modules in Python. we further practiced using the builtin function
...
* **2. How to make a script dynamical!**
